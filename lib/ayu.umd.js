...
var components = [Button, Icon, Carousel, Carousel_item, FloatInput, Pagination, Select, Select_option, Hover_tip, Input]; // 定义 install 方法，接收 Vue 作为参数。如果使用 use 注册插件，则所有的组件都将被注册
