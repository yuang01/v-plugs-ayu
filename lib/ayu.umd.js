...
var Select_src_component = normalizeComponent(
  ...
  srcvue_type_template_id_23c4480e_render,
  srcvue_type_template_id_23c4480e_staticRenderFns,
  false,
  null,
  null,
  null
...
var components = [Button, Icon, Carousel, Carousel_item, FloatInput, Pagination, Select, Select_option, Hover_tip]; // 定义 install 方法，接收 Vue 作为参数。如果使用 use 注册插件，则所有的组件都将被注册
